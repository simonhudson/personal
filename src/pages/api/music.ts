...
export const GET: APIRoute = async (): Promise<Response> => {
	assert(import.meta.env.LASTFM_USERNAME, 'LASTFM_USERNAME environment variable is not set');
	assert(import.meta.env.LASTFM_API_KEY, 'LASTFM_API_KEY environment variable is not set');
